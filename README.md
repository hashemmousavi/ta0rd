...
cd $HOME
git clone https://github.com/TardTeam/TeleTard_SuperGroups.git
cd TeleTard_SuperGroups
./launch.sh install
./launch.sh  or screen ./launch.sh # Will ask you for a phone number & confirmation code.
```
